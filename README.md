Aplicação em Typescript usando Next.js e Chakra Ui para estilização (usando templates já prontos para a parte visual) Para cadastro e login de usuários que serão autentificados no banco de dados postre.
